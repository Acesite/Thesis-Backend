...
// GET /api/managevoters/dashboard-stats
    ...
    (err, barangayRows) => {
      ...
      db.query(
        `SELECT COUNT(DISTINCT precinct_id) AS total 
         FROM tbl_households WHERE precinct_id IS NOT NULL`,
        (err2, precinctRows) => {
          if (err2) {
...
// GET /api/managevoters/barangay-analytics
...
// GET /api/managevoters/quick-insights
...
// GET /api/managevoters/recent-activity
